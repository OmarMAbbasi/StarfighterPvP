		...
		{!gameStarted ? (
			player.playerTag === myTag ? (
				<button
					...
					onClick={e => socket.emit("playerReady", { roomId: gameId })}
				>
			...
			<div className="player-list-started">
				...
				{player.health > 100 ? (
					...
					>
						...
						>
							<i className="fas fa-shield-alt">&#160;&#160;{player.health}%</i>
						</div>
					</div>
				) : (
					<div
					...
					>
						...
						>
							<i className="fas fa-plus">&#160;&#160;{player.health}%</i>
						</div>
					</div>
				)}
			</div>
